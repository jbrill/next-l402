...
describe('L402 Integration Tests', () => {
  ...
  describe('Complete L402 Flow', () => {
    it('should handle complete authentication flow with l402Server', async () => {
      ...
      const req1 = new NextRequest('https://api.example.com/api/protected/data');
      ...
      const req2 = new NextRequest('https://api.example.com/api/protected/data', {
        headers: {
      ...
      const protectResponse = await auth2.protect();
  ...
  describe('Middleware Integration', () => {
    it('should create proper L402 middleware configuration', async () => {
      ...
      const req2 = new NextRequest('https://api.example.com/api/protected/resource');
    ...
    it('should validate route patterns correctly', () => {
      ...
      const req = (path: string) => new NextRequest(`https://api.example.com${path}`);
  ...
  describe('Error Handling', () => {
    it('should handle Lightning client errors gracefully', async () => {
      ...
      jest.spyOn(failingLightning, 'createInvoice').mockRejectedValue(
        new Error('Lightning node offline')
      );
